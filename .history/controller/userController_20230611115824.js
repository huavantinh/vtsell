...
const createUser = async (req, res) => {
  try {
    const datauser = await prisma.users.screate({
      data: {
        username: "hvt",
        password:
          "$2a$12$wqRt8qNpu.g0h8.7IcuZZebrCgNb1dFye9OI1.nSJjKXvWrwv7BNm",
...
//login user
// fix loi chua vao catch. khi nhap body sai dinh dang JSON, khong vao catch
